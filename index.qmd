...
En primer lugar, para reproducir la **Figura 2**, se seleccionan las variables "rama1" "sexo" y "activ". La variable "rama1" corresponde a una clasificación de las ramas de actividad económica en base a la CIIU. Por otro lado, la variable "activ" indica la condición de actividad de la persona, es decir, si se encuentra ocupada (1), desocupada (2) o inactiva (3). Para esta figura, se seleccionan únicamente las personas ocupadas.
...
Para reproducir la *Figura 5* de @palma_desafiando_2025, primeramente se deben seleccionar las variables
